...
//client info에 저장
var color = "pink"; //각 videoinfo에 저장되어야 하는 변수
...
function toggleImgstart() {
  ...
  if (startclicknum % 2 == 0) {
    document.getElementById("startbtn").src = "buttons/startbutton-" + color + ".png"; //startTime = 0;
  } else {
    document.getElementById("startbtn").src = "buttons/startbutton2-" + color + ".png"; //startTime = document.getElementById("youtubeMP4").currentTime;
...
function toggleImgend() {
  ...
  if (endclicknum % 2 == 0) {
    document.getElementById("endbtn").src = "buttons/endbutton-" + color + ".png"; //endTime = 0;
  } else {
    document.getElementById("endbtn").src = "buttons/endbutton2-" + color + ".png"; //endTime = document.getElementById("youtubeMP4").currentTime;
  } //console.log(endTime);
...
function hoverdescription() {
  document.getElementById("unseen1").style.display = "block";
  document.getElementById("unseen2").style.display = "block";
}

function nohoverdescription() {
  document.getElementById("unseen1").style.display = "none";
  document.getElementById("unseen2").style.display = "none";
}
...
document.getElementById('startbtn').addEventListener('click', toggleImgstart); //document.getElementById('codebtn').addEventListener('click', toggleImgcode);
...
function makeImgarea(url) {
  ...
  imgLi.className = "ui-state-default"; //imgLi.style.backgroundColor = "var(--color-background-gray)";
...
function makeCodearea(text) {
  ...
  codeLi.className = "ui-state-default"; //codeLi.style.backgroundColor = "var(--color-background-gray)";
  ...
  resultDiv.style.width = "100%"; //resultDiv.style.height = "20px";
...
function makeTextarea(text) {
  ...
  textLi.className = "ui-state-default"; //textLi.style.backgroundColor = "var(--color-background-gray)";
  ...
  textDiv.style.paddingBottom = "0px"; //textDiv.style.paddingLeft = "34px";
...
function updateTimestamp() {
  ...
  var timeparent = document.getElementById("realtimestamp"); //timestamp 순서 조정
...
function changebutton() {
  ...
  if (openedit == false) {
    ...
    orderchange = false;
    clickdeletionbtn = false; //console.log('open');
  } else {
    ...
    document.getElementById("backbtn").style.display = "none"; //console.log('close');
  }
}
