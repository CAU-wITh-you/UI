(function() {
   ...
   */
    ...
    function wa(a) {
        var b = a.H.splice(0)[0];
        (b = a.j = a.j || b) ? b.Ra ? a.h = a.v || a.m : void 0 != b.o && a.m < b.o ? (a.h = b.o,
        a.j = null) : a.h = a.m : a.h = 0
    }
    function xa(a) {
        this.h = new oa;
        this.i = a
    ...
    function Ba(a) {
        this.next = function(b) {
            pa(a.h);
            a.h.l ? b = za(a, a.h.l.next, b, a.h.A) : (a.h.A(b),
            b = Aa(a));
            return b
        }
        ;
        this.throw = function(b) {
            pa(a.h);
            a.h.l ? b = za(a, a.h.l["throw"], b, a.h.A) : (ra(a.h, b),
            b = Aa(a));
            return b
        }
        ;
    ...
    r("Promise", function(a) {
        ...
        b.prototype.la = function(g) {
            ...
            "function" == typeof h ? this.fb(h, g) : this.v(g)
        }
        ;
        ...
        b.prototype.then = function(g, h) {
            function k(u, q) {
                return "function" == typeof u ? function(v) {
                    try {
                        l(u(v))
                    } catch (x) {
                        n(x)
    ...
    : function(a, b, c) {
      ...
      , Wa = Array.prototype.reduce ? function(a, b, c) {
    ...
    function nb(a, b) {
        if (b)
            a = a.replace(ob, "&amp;").replace(pb, "&lt;").replace(qb, "&gt;").replace(rb, "&quot;").replace(sb, "&#39;").replace(tb, "&#0;");
        else {
            if (!ub.test(a))
                return a;
    ...
    ;
    var xb = RegExp('^(?:audio/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font/\\w+|image/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\\w+=(?:\\w+|"[\\w;,= ]+"))*$', "i")
      , yb = /^data:(.*);base64,[a-z0-9+\/]+=*$/i
      , zb = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i
      , wb = {}
      , Ab = new vb("about:invalid#zClosurez",wb);
    var Bb;
    a: {
        var Db = B.navigator;
        if (Db) {
    ...
    var Ub = H("Opera")
      , Vb = H("Trident") || H("MSIE")
      , Wb = H("Edge")
      , Xb = H("Gecko") && !(-1 != Bb.toLowerCase().indexOf("webkit") && !H("Edge")) && !(H("Trident") || H("MSIE")) && !H("Edge")
      , Yb = -1 != Bb.toLowerCase().indexOf("webkit") && !H("Edge");
    function Zb() {
        var a = B.document;
    ...
    if (B.document && Vb) {
        var fc = Zb();
        ec = fc ? fc : parseInt(dc, 10) || void 0
    } else
        ec = void 0;
    var gc = ec;
    var hc = Sb() || H("iPod")
    ...
    !H("Android") || Fb();
    Fb();
    var jc = H("Safari") && !(Fb() || H("Coast") || H("Opera") || H("Edge") || H("Edg/") || H("OPR") || H("Firefox") || H("FxiOS") || H("Silk") || H("Android")) && !(Sb() || H("iPad") || H("iPod"));
    var kc = {}
      , lc = null;
    function mc(a, b) {
        Ka(a);
    ...
    ;var nc = "function" === typeof Uint8Array;
    var oc = "function" === typeof Symbol && "symbol" === typeof Symbol() ? Symbol(void 0) : void 0;
    function pc(a) {
        if (!Array.isArray(a))
            return a;
        Object.isFrozen(a) || (oc ? a[oc] |= 1 : void 0 !== a.h ? a.h |= 1 : Object.defineProperties(a, {
            h: {
                value: 1,
                configurable: !0,
                writable: !0,
    ...
    function rc(a) {
        ...
        case "object":
            return nc && null != a && a instanceof Uint8Array ? mc(a) : a;
        default:
            return a
        }
    }
    ;function sc(a, b) {
        if (null != a)
            return Array.isArray(a) || qc(a) ? tc(a, b) : b(a)
    }
    function tc(a, b) {
        if (Array.isArray(a)) {
    ...
    function uc(a) {
        return nc && null != a && a instanceof Uint8Array ? new Uint8Array(a) : a
    }
    ;function vc(a, b) {
        this.i = a;
        this.j = b;
        ...
        if (0 < this.i.length) {
            for (a = 0; a < this.i.length; a++) {
                b = this.i[a];
                var c = b[0];
                this.h[c.toString()] = new wc(c,b[1])
            }
            this.l = !0
        }
    }
    ...
    ;
    function yc(a, b) {
        return a.j ? (b.h || (b.h = new a.j(b.value)),
        b.h) : b.value
    }
    m.get = function(a) {
        if (a = this.h[a.toString()])
            return yc(this, a)
    }
    ;
    m.has = function(a) {
    ...
    ;
    zc.prototype[Symbol.iterator] = function() {
        return this
    }
    ;
    var Ac;
    function Bc(a, b, c) {
        ...
        Ac = null;
        a || (a = d);
        d = this.constructor.Ob;
        a || (a = d ? [d] : []);
        this.l = (d ? 0 : -1) - (this.constructor.Nb || 0);
        this.h = null;
        this.i = a;
        a: {
            d = this.i.length;
            ...
            void 0 !== b && -1 < b ? (this.m = Math.max(b, a + 1 - this.l),
            this.j = null) : this.m = Number.MAX_VALUE
        }
        if (c)
            for (b = 0; b < c.length; b++)
                a = c[b],
                a < this.m ? (a += this.l,
                (d = this.i[a]) ? pc(d) : this.i[a] = Cc) : (Dc(this),
                (d = this.j[a]) ? pc(d) : this.j[a] = Cc)
    }
    var Cc = Object.freeze(pc([]));
    function Dc(a) {
        var b = a.m + a.l;
        a.i[b] || (a.j = a.i[b] = {})
    }
        ...
        if (c) {
            ...
            for (e in c) {
                ...
                if (f) {
                    ...
                    if (Array.isArray(f)) {
                        if (f.length)
                            for (g = Ic(a, f[0].constructor, h, g),
                            h = 0; h < Math.min(g.length, f.length); h++)
                                Jc(g[h], f[h])
                    } else
                        f instanceof vc ? f.j && (d.wa = Fc(a, h, f.j),
                        f.forEach(function(k) {
                            return function(l, n) {
                                return Jc(k.wa.get(n), l)
                            }
                        }(d))) : (g = Hc(a, f.constructor, h, g)) && Jc(g, f)
                }
                d = {
                    wa: d.wa
                }
    ...
    lb("pagead2.googlesyndication.com");
   ...
   */
    ...
    function Oc(a, b, c) {
        var d = arguments
          ...
          , f = d[1]
          , g = Pc(e, String(d[0]));
        f && ("string" === typeof f ? g.className = f : Array.isArray(f) ? g.className = f.join(" ") : Mc(g, f));
        2 < d.length && Qc(e, g, d);
        return g
    }
    function Qc(a, b, c) {
    ...
    var Tc = {
        wb: "allow-forms",
        xb: "allow-modals",
        yb: "allow-orientation-lock",
        zb: "allow-pointer-lock",
        Ab: "allow-popups",
        Bb: "allow-popups-to-escape-sandbox",
        Cb: "allow-presentation",
        Db: "allow-same-origin",
        Eb: "allow-scripts",
        Fb: "allow-top-navigation",
        Gb: "allow-top-navigation-by-user-activation"
    }
      , Vc = Ua(function() {
        return Uc()
    });
    ...
    ;function $c() {
        ...
        function b(p) {
            for (var u = g, q = 0; 64 > q; q += 4)
                u[q / 4] = p[q] << 24 | p[q + 1] << 16 | p[q + 2] << 8 | p[q + 3];
            for (q = 16; 80 > q; q++)
                p = u[q - 3] ^ u[q - 8] ^ u[q - 14] ^ u[q - 16],
                u[q] = (p << 1 | p >>> 31) & 4294967295;
            p = e[0];
            var v = e[1]
              , x = e[2]
              , A = e[3]
            ...
            for (q = 0; 80 > q; q++) {
                if (40 > q)
                    ...
                    60 > q ? (K = v & x | A & (v | x),
                    M = 2400959708) : (K = v ^ x ^ A,
                    M = 3395469782);
                K = ((p << 5 | p >>> 27) & 4294967295) + K + J + M + u[q] & 4294967295;
                J = A;
                A = x;
        ...
        function c(p, u) {
            if ("string" === typeof p) {
                ...
                for (var q = [], v = 0, x = p.length; v < x; ++v)
                    q.push(p.charCodeAt(v));
                p = q
            }
            u || (u = p.length);
            q = 0;
        ...
        return {
            ...
            digest: d,
            jb: function() {
                for (var p = d(), u = "", q = 0; q < p.length; q++)
                    u += "0123456789ABCDEF".charAt(Math.floor(p[q] / 16)) + "0123456789ABCDEF".charAt(p[q] % 16);
                return u
            }
        }
    }
    ;function ad(a, b, c) {
        ...
        return d && a && b ? [b, bd(Zc(d), a, c || null)].join(" ") : null
    }
    function bd(a, b, c) {
        var d = []
          , e = [];
    ...
    ;
    var fd = new ed("undefined" == typeof document ? null : document);
    function gd(a) {
        return !!dd.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a)
    }
    function hd(a, b, c, d) {
        (a = B[a]) || (a = (new ed(document)).get(b));
        return a ? ad(a, c, d) : null
    }
    function id(a) {
        var b = void 0 === b ? !1 : b;
        var c = Zc(String(B.location.href))
          , d = [];
        var e = b;
        e = void 0 === e ? !1 : e;
        var f = B.__SAPISID || B.__APISID || B.__3PSAPISID || B.__OVERRIDE_SID;
        gd(e) && (f = f || B.__1PSAPISID);
        if (f)
            e = !0;
        else {
            var g = new ed(document);
            f = g.get("SAPISID") || g.get("APISID") || g.get("__Secure-3PAPISID") || g.get("SID");
            gd(e) && (f = f || g.get("__Secure-1PAPISID"));
            e = !!f
        }
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? B.__SAPISID : B.__APISID,
        e || (e = new ed(document),
        e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")),
        (e = e ? ad(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e),
        c && gd(b) && ((b = hd("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b),
        (a = hd("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
    ...
    var qd = function() {
        ...
        try {
            B.addEventListener("test", Ia, b),
            B.removeEventListener("test", Ia, b)
        } catch (c) {}
        return a
    }();
    function rd(a, b) {
    ...
    xd.prototype.add = function(a, b, c, d, e) {
        ...
        var g = yd(a, b, d, e);
        -1 < g ? (b = a[g],
        c || (b.ma = !1)) : (b = new vd(b,this.src,f,!!d,e),
        b.ma = c,
        a.push(b));
        return b
    }
    ...
    function zd(a, b) {
        var c = b.type;
        c in a.listeners && Xa(a.listeners[c], b) && (wd(b),
    ...
    function yd(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.ia && f.listener == b && f.capture == !!c && f.qa == d)
                return e
        }
        return -1
    }
    ...
    function Dd(a, b, c, d, e) {
        if (d && d.once)
            ...
            c = Fd(c),
            a && a[td] ? a.X(b, c, D(d) ? !!d.capture : !!d, e) : Gd(a, b, c, !1, d, e)
    }
    ...
    function Ed(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            c = Fd(c),
            a && a[td] ? a.h.add(String(b), c, !0, D(d) ? !!d.capture : !!d, e) : Gd(a, b, c, !0, d, e)
    }
    function Md(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            (d = D(d) ? !!d.capture : !!d,
            c = Fd(c),
            a && a[td]) ? a.h.remove(String(b), c, d, e) : a && (a = Hd(a)) && (b = a.listeners[b.toString()],
            a = -1,
            b && (a = yd(b, c, d, e)),
            (c = -1 < a ? b[a] : null) && Nd(c))
    }
    ...
    function Pd(a, b) {
        ...
        a = a.xa;
        c = b.type || b;
        "string" === typeof b ? b = new ld(b,a) : b instanceof ld ? b.target = b.target || a : (e = b,
        b = new ld(c,a),
        hb(b, e));
        e = !0;
        if (d)
    ...
    ;
    I.prototype.X = function(a, b, c, d) {
    ...
    function Td(a) {
        a.A = a.J.K(function() {
            ...
            return z(function(c) {
                if (1 == c.h)
                    return a.i ? (null === (b = window.navigator) || void 0 === b ? 0 : b.onLine) ? c.o(3) : y(c, Sd(a), 3) : y(c, Sd(a), 3);
                Td(a);
                c.h = 0
            })
        }, 3E4)
        ...
        return a.u ? a.u : a.u = new Promise(function(c) {
            ...
            return z(function(g) {
                ...
                case 1:
                    ...
                    f = !1,
                    sa(g, 2, 3),
                    d && (a.j = a.J.K(function() {
                        d.abort()
                    }, b || 2E4)),
                    y(g, fetch("/generate_204", {
                        method: "HEAD",
                        signal: e
                    }), 5);
                case 5:
                ...
                case 3:
                    ...
                    a.j = 0);
                    f !== a.i && (a.i = f,
                    a.i ? Pd(a, "networkstatus-online") : Pd(a, "networkstatus-offline"));
                    c(f);
                    wa(g);
                    break;
                case 2:
    ...
    Ud.prototype.set = function(a, b) {
        b = void 0 === b ? !0 : b;
        0 <= a && 52 > a && 0 === a % 1 && this.data_[a] != b && (this.data_[a] = b,
        this.h = -1)
    }
    ;
    ...
    ;
    function Vd(a) {
        -1 == a.h && (a.h = Wa(a.data_, function(b, c, d) {
    ...
    function ee() {
        if (B.Promise && B.Promise.resolve) {
            ...
            de = function() {
                var b = he;
                "function" !== typeof B.setImmediate || B.Window && B.Window.prototype && !H("Edge") && B.Window.prototype.setImmediate == B.setImmediate ? (Yd || (Yd = Zd()),
                Yd(b)) : B.setImmediate(b)
            }
    }
    var fe = !1
      , ge = new $d;
    ...
    le.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
    ...
    ;
    var ne = "StopIteration"in B ? B.StopIteration : {
    ...
    ;
    function se(a) {
        if (a instanceof te || a instanceof ue || a instanceof ve)
            return a;
    ...
    ;
    m.delete = function(a) {
        return Ae(this.i, a) ? (delete this.i[a],
        --this.size,
        this.j++,
        this.h.length > 2 * this.size && ze(this),
        !0) : !1
    }
    ;
    function ze(a) {
    ...
    m.get = function(a, b) {
        return Ae(this.i, a) ? this.i[a] : b
    }
    ;
    m.set = function(a, b) {
        Ae(this.i, a) || (this.size += 1,
        this.h.push(a),
        this.j++);
        this.i[a] = b
    }
    ;
    m.forEach = function(a, b) {
        for (var c = ye(this), d = 0; d < c.length; d++) {
            var e = c[d]
              , f = this.get(e);
            a.call(b, f, e, this)
        }
    ...
    ;
    m.keys = function() {
        return se(this.I(!0)).i()
    }
    ;
    m.values = function() {
        return se(this.I(!1)).i()
    }
    ;
    m.entries = function() {
        var a = this;
        return je(this.keys(), function(b) {
            return [b, a.get(b)]
        })
    }
    ;
        ...
        if (0 == a.h)
            if (a.j) {
                ...
                if (c.i) {
                    ...
                    !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e && (0 == c.h && 1 == d ? Ke(c, b) : (f ? (d = f,
                    d.next == c.l && (c.l = d),
                    d.next = d.next.next) : Le(c),
                    Me(c, e, 3, b)))
                }
                a.j = null
            } else
    ...
    m.ka = function(a) {
        ...
        if (b) {
            var c = this.i[b];
            0 != this.m ? (this.j.push(a),
            this.h[a + 1] = Ia) : (c && Xa(c, a),
            delete this.h[a],
            delete this.h[a + 1],
            delete this.h[a + 2])
        }
    ...
    m.ba = function(a, b) {
        ...
        if (c) {
            ...
            if (this.A)
                ...
                try {
                    for (e = 0,
                    f = c.length; e < f && !this.l; e++)
                        g = c[e],
                        this.h[g + 1].apply(this.h[g + 2], d)
                } finally {
                    if (this.m--,
                    0 < this.j.length && 0 == this.m)
                        for (; c = this.j.pop(); )
                            this.ka(c)
                }
            }
    ...
    We.prototype.set = function(a, b) {
        void 0 === b ? this.h.remove(a) : this.h.set(a, Ce(b))
    }
    ;
    ...
    Xe.prototype.set = function(a, b) {
        Xe.M.set.call(this, a, Ze(b))
    }
    ;
    Xe.prototype.i = function(a) {
        a = Xe.M.get.call(this, a);
    ...
    $e.prototype.set = function(a, b, c) {
        ...
        $e.M.set.call(this, a, b)
    }
    ;
    $e.prototype.i = function(a) {
        var b = $e.M.i.call(this, a);
        if (b) {
            var c = b.creation
              , d = b.expiration;
    ...
    m.I = function(a) {
        ...
        d.next = function() {
            ...
            var f = c[b++];
            if (a)
                return qe(decodeURIComponent(f.nodeName.replace(/\./g, "%")).substr(1));
            f = f.nodeValue;
            if ("string" !== typeof f)
                throw "Storage mechanism: Invalid value was encountered";
            return qe(f)
    ...
    kf.prototype.I = function(a) {
        ...
        d.next = function() {
            ...
            return qe(a ? f.substr(c.h.length) : c.i.get(f))
        }
        ;
        var e = d.next;
        d.O = function() {
    ...
    w(lf, Bc);
    var mf, nf, of, pf = B.window, qf = (null === (mf = null === pf || void 0 === pf ? void 0 : pf.yt) || void 0 === mf ? void 0 : mf.config_) || (null === (nf = null === pf || void 0 === pf ? void 0 : pf.ytcfg) || void 0 === nf ? void 0 : nf.data_) || {}, rf = (null === (of = null === pf || void 0 === pf ? void 0 : pf.ytcfg) || void 0 === of ? void 0 : of.obfuscatedData_) || [];
    function sf() {
    ...
    function tf() {
        var a = arguments;
        1 < a.length ? qf[a[0]] = a[1] : 1 === a.length && Object.assign(qf, a[0])
    }
    function N(a, b) {
        return a in qf ? qf[a] : b
    }
    function uf() {
    ...
    ;
    Cf.prototype.stopImmediatePropagation = function() {
        this.event && (this.event.cancelBubble = !0,
        this.event.stopImmediatePropagation && this.event.stopImmediatePropagation())
    }
    ;
    var db = B.ytEventsEventsListeners || {};
    E("ytEventsEventsListeners", db);
    var Df = B.ytEventsEventsCounter || {
        count: 0
    };
    E("ytEventsEventsCounter", Df);
    function Ef(a, b, c, d) {
        d = void 0 === d ? {} : d;
        ...
        G(a, function(b) {
            if (b in db) {
                var c = db[b]
                  ...
                  , f = c[3];
                c = c[4];
                d.removeEventListener ? Gf() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete db[b]
            }
        }))
    }
    ...
    function Hf(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function(h) {
                    h = new Cf(h);
                    if (!Rc(h.relatedTarget, function(k) {
                        return k == a
                    }))
                ...
                Gf() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                db[e] = [a, b, c, g, d]
            }
        }
    }
    ;function If(a, b) {
        "function" === typeof a && (a = xf(a));
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length)
                try {
                    var g = Nf(f[0] || "")
                      , h = Nf(f[1] || "");
                    g in c ? Array.isArray(c[g]) ? $a(c[g], h) : c[g] = [c[g], h] : c[g] = h
                } catch (p) {
                    var k = p
                      , l = f[0]
                      , n = String(Mf);
                    k.args = [{
                        ...
                        value: f[1],
                        query: a,
                        method: Of == n ? "unchanged" : n
                    }];
                    Lf.hasOwnProperty(l) || zf(k)
                }
        }
        return c
    }
    ...
    function Sf(a) {
        ...
        c && d ? (a = a.match(Jb),
        b = b.match(Jb),
        a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]) : a = d ? Lb(b) == d && (Number(b.match(Jb)[4] || null) || null) == (Number(a.match(Jb)[4] || null) || null) : !0;
        return a
    }
    function Nf(a) {
    ...
    function dg(a) {
        ...
        try {
            ...
            e.u_his = h;
            var k;
            e.u_h = null == (k = Kc.screen) ? void 0 : k.height;
            var l;
            e.u_w = null == (l = Kc.screen) ? void 0 : l.width;
            var n;
            e.u_ah = null == (n = Kc.screen) ? void 0 : n.availHeight;
            var p;
            e.u_aw = null == (p = Kc.screen) ? void 0 : p.availWidth;
            var u;
            e.u_cd = null == (u = Kc.screen) ? void 0 : u.colorDepth
        } catch (qa) {}
        h = b.h;
        try {
            var q = h.screenX;
        ...
        try {
            var Id = h.screen.availWidth;
            var gj = h.screen.availTop
        } catch (qa) {}
        q = [M, Cb, q, v, Id, gj, x, A, J, K];
        v = b.h.top;
        try {
            var cb = (v || window).document
              , Z = "CSS1Compat" == cb.compatMode ? cb.documentElement : cb.body;
            var ea = (new Lc(Z.clientWidth,Z.clientHeight)).round()
        } catch (qa) {
            ea = new Lc(-12245933,-12245933)
        }
        cb = ea;
        ea = {};
        Z = new Ud;
        B.SVGElement && B.document.createElementNS && Z.set(0);
        v = Wc();
        v["allow-top-navigation-by-user-activation"] && Z.set(1);
        v["allow-popups-to-escape-sandbox"] && Z.set(2);
        B.crypto && B.crypto.subtle && Z.set(3);
        B.TextDecoder && B.TextEncoder && Z.set(4);
        Z = Vd(Z);
        ea.bc = Z;
        ea.bih = cb.height;
        ea.biw = cb.width;
        ...
        ea.wgl = !!Kc.WebGLRenderingContext,
        ea);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
    ...
    Date.now();
    var fg = "XMLHttpRequest"in B ? function() {
    ...
    function kg(a, b) {
        ...
        if (c || !Lb(a))
            b["X-YouTube-Ad-Signals"] = Pf(dg(void 0));
        return b
    }
    function lg(a) {
        var b = window.location.search
          , c = Lb(a);
        O("debug_handle_relative_url_for_query_forward_killswitch") || c || !Sf(a) || (c = document.location.hostname);
          ...
          , f = pg(a, function(k) {
            if (!e) {
                ...
                var n = null
                  ...
                  , u = 500 <= k.status && 600 > k.status;
                if (l || p || u)
                    n = qg(a, c, k, b.convertToSafeHtml);
                if (l)
                    a: if (k && 204 == k.status)
                        l = !0;
                    else {
    ...
    function og(a, b) {
        var c = N("XSRF_FIELD_NAME", void 0), d = N("XSRF_TOKEN", void 0), e = b.postBody || "", f = b.postParams, g = N("XSRF_FIELD_NAME", void 0), h;
        b.headers && (h = b.headers["Content-Type"]);
        b.excludeXsrf || Lb(a) && !b.withCredentials && Lb(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}),
        f[c] = d);
        f && "string" === typeof e && (e = Qf(e),
        hb(e, f),
        e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : Ob(e));
        if (!(a = e) && (a = f)) {
            a: {
                for (var k in f) {
                    f = !1;
        ...
        !jg && a && "POST" != b.method && (jg = !0,
        yf(Error("AJAX request with postData should use POST")));
        return e
    }
    function qg(a, b, c, d) {
        var e = null;
        ...
        case "JSON":
            ...
            break;
        case "XML":
            if (a = (a = c.responseXML) ? rg(a) : null)
                e = {},
    ...
    function pg(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState"in k ? k.readyState : 0) && b && xf(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = gg();
        ...
        O("debug_forward_web_query_parameters") && (a = lg(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    function yg(a, b, c, d, e) {
        ...
        if (a)
            if (c && !vg("cobalt"))
                a && (a instanceof vb || (a = "object" == typeof a && a.ga ? a.fa() : String(a),
                zb.test(a) ? a = new vb(a,wb) : (a = String(a),
                a = a.replace(/(%0A|%0D)/g, ""),
                a = (b = a.match(yb)) && xb.test(b[1]) ? new vb(a,wb) : null)),
                a = a || Ab,
                a instanceof vb && a.constructor === vb ? a = a.h : (Ja(a),
                a = "type_error:SafeUrl"),
                "about:invalid#zClosurez" === a || a.startsWith("data") ? a = "" : (a instanceof Hb || (b = "object" == typeof a,
                c = null,
                b && a.Qa && (c = a.Oa()),
                a = Ib(nb(b && a.ga ? a.fa() : String(a)), c)),
                a instanceof Hb && a.constructor === Hb ? a = a.h : (Ja(a),
                a = "type_error:SafeHtml"),
                a = encodeURIComponent(String(Ce(a.toString())))),
                /^[\s\xa0]*$/.test(a) || (a = Oc("IFRAME", {
                ...
                b: {
                    try {
                        ...
                        if (f.j && f.i || f.l) {
                            var g = Kb(a.match(Jb)[5] || null);
                            var h = !(!g || !g.endsWith("/aclk") || "1" !== Qb(a, "ri"));
                            break b
                        }
                    } catch (k) {}
                    h = !1
    ...
    function Bg() {
        var a = void 0 === a ? "" : a;
        zg("/generate_204", a) || yg("/generate_204", void 0, void 0, void 0, a)
    }
    function zg(a, b) {
        try {
            if (window.navigator && window.navigator.sendBeacon && window.navigator.sendBeacon(a, void 0 === b ? "" : b))
                return !0
        } catch (c) {}
        return !1
    }
    ...
    ;var Cg = B.ytPubsubPubsubInstance || new L
      , Dg = B.ytPubsubPubsubSubscribedKeys || {}
      , Eg = B.ytPubsubPubsubTopicToKeys || {}
      , Fg = B.ytPubsubPubsubIsSynchronous || {};
    L.prototype.subscribe = L.prototype.subscribe;
    L.prototype.unsubscribeByKey = L.prototype.ka;
    L.prototype.publish = L.prototype.ba;
    L.prototype.clear = L.prototype.clear;
    E("ytPubsubPubsubInstance", Cg);
    E("ytPubsubPubsubTopicToKeys", Eg);
    E("ytPubsubPubsubIsSynchronous", Fg);
    E("ytPubsubPubsubSubscribedKeys", Dg);
    var Gg = window
      , P = Gg.ytcsi && Gg.ytcsi.now ? Gg.ytcsi.now : Gg.performance && Gg.performance.timing && Gg.performance.now && Gg.performance.timing.navigationStart ? function() {
        return Gg.performance.timing.navigationStart + Gg.performance.now()
    }
    : function() {
        return (new Date).getTime()
    }
    ;
    var Hg = Uf("initial_gel_batch_timeout", 2E3)
      , Ig = Math.pow(2, 16) - 1
      , Jg = void 0
      , Kg = 0
      , Lg = 0
      , Mg = 0
      , Ng = !0
      , Og = B.ytLoggingTransportGELQueue_ || new Map;
    E("ytLoggingTransportGELQueue_", Og);
    var Pg = B.ytLoggingTransportTokensToCttTargetIds_ || {};
    ...
    function Qg(a, b) {
        if ("log_event" === a.endpoint) {
            ...
            d.push(a.payload);
            b && (Jg = new b);
            a = Uf("tvhtml5_logging_max_batch") || Uf("web_logging_max_batch") || 100;
            b = P();
            d.length >= a ? Sg({
                writeThenSend: !0
            }, O("flush_only_full_queue") ? c : void 0) : 10 <= b - Mg && (Tg(),
            Mg = b)
        }
    }
    function Ug(a, b) {
    ...
    function Tg() {
        O("web_gel_timeout_cap") && !Lg && (Lg = If(function() {
            Sg({
                writeThenSend: !0
            })
        }, 6E4));
        window.clearTimeout(Kg);
        var a = N("LOGGING_BATCH_TIMEOUT", Uf("web_gel_debounce_ms", 1E4));
        O("shorten_initial_gel_batch_timeout") && Ng && (a = Hg);
        Kg = If(function() {
            Sg({
                writeThenSend: !0
            })
    ...
    function Vg(a, b, c, d) {
        ...
        for (var h = a.next(); !h.done; h = a.next()) {
            ...
            O("send_beacon_before_gel") && window.navigator && window.navigator.sendBeacon && !c.writeThenSend && Bg();
            $g(e, "log_event", k, ah(c, h, function() {
                g--;
                g || b()
            }, function() {
                g--;
    ...
    function Zg(a, b, c) {
        ...
        !c && (b = N("EVENT_ID", void 0)) && ((c = N("BATCH_CLIENT_COUNTER", void 0) || 0) || (c = Math.floor(Math.random() * Ig / 2)),
        c++,
        c > Ig && (c = 1),
        tf("BATCH_CLIENT_COUNTER", c),
    ...
    ;var bh = B.ytLoggingGelSequenceIdObj_ || {};
    E("ytLoggingGelSequenceIdObj_", bh);
    function ch() {
        if (!B.matchMedia)
    ...
    ;function gh() {
        return "INNERTUBE_API_KEY"in qf && "INNERTUBE_API_VERSION"in qf
    }
    function Xg() {
        return {
            innertubeApiKey: N("INNERTUBE_API_KEY", void 0),
            innertubeApiVersion: N("INNERTUBE_API_VERSION", void 0),
            lb: N("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            Ba: N("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            Mb: N("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
            innertubeContextClientVersion: N("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0),
            nb: N("INNERTUBE_CONTEXT_HL", void 0),
            mb: N("INNERTUBE_CONTEXT_GL", void 0),
            ob: N("INNERTUBE_HOST_OVERRIDE", void 0) || "",
            qb: !!N("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            pb: !!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function Wg(a) {
        ...
        f = a.Ba;
        if (("WEB" === f || "MWEB" === f || 1 === f || 2 === f) && b) {
            var g;
            b.client.mainAppWebInfo = null != (g = b.client.mainAppWebInfo) ? g : {};
            b.client.mainAppWebInfo.webDisplayMode = ch()
        }
        g = a.Ba;
        if (("WEB_REMIX" === g || 76 === g) && !O("music_web_display_mode_killswitch") && b) {
            var h;
            b.client.Sa = null != (h = b.client.Sa) ? h : {};
            b.client.Sa.webDisplayMode = ch()
        }
        var k;
        if (O("web_log_memory_total_kbytes") && (null == (k = B.navigator) ? 0 : k.deviceMemory)) {
            var l;
            h = null == (l = B.navigator) ? void 0 : l.deviceMemory;
            b && (b.client.memoryTotalKbytes = "" + 1E6 * h)
        }
        a.appInstallData && b && (b.client.configInfo = b.client.configInfo || {},
        b.client.configInfo.appInstallData = a.appInstallData);
        a: {
            if (l = fh()) {
                a = dh[l.type || "unknown"] || "CONN_UNKNOWN";
                l = dh[l.effectiveType || "unknown"] || "CONN_UNKNOWN";
                "CONN_CELLULAR_UNKNOWN" === a && "CONN_UNKNOWN" !== l && (a = l);
                if ("CONN_UNKNOWN" !== a)
                    break a;
                if ("CONN_UNKNOWN" !== l) {
                    a = l;
        ...
        a && b && (b.client.connectionType = a);
        O("web_log_effective_connection_type") && (a = fh(),
        a = null !== a && void 0 !== a && a.effectiveType ? eh.hasOwnProperty(a.effectiveType) ? eh[a.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0,
        a && b && (b.client.effectiveConnectionType = a));
        ...
        h = b.client;
        k = {};
        g = t(Object.entries(Qf(N("DEVICE", ""))));
        for (f = g.next(); !f.done; f = g.next())
            e = t(f.value),
            f = e.next().value,
            e = e.next().value,
            "cbrand" === f ? k.deviceMake = e : "cmodel" === f ? k.deviceModel = e : "cbr" === f ? k.browserName = e : "cbrver" === f ? k.browserVersion = e : "cos" === f ? k.osName = e : "cosver" === f ? k.osVersion = e : "cplatform" === f && (k.platform = e);
        b.client = l.call(a, h, k);
        return b
    }
    function hh(a, b, c) {
        c = void 0 === c ? {} : c;
        ...
        if (b && b.includes("www.youtube-nocookie.com"))
            return d;
        (b = c.Ib || N("AUTHORIZATION")) || (a ? b = "Bearer " + C("gapi.auth.getToken")().Hb : b = id([]));
        b && (d.Authorization = b,
    ...
    ;function jh(a) {
        var b = new df;
        (b = b.isAvailable() ? a ? new kf(b,a) : b : null) || (a = new ef(a || "UserDataSharedStore"),
        b = a.isAvailable() ? a : null);
        this.h = (a = b) ? new $e(a) : null;
        this.i = document.domain || window.location.hostname
    }
    jh.prototype.set = function(a, b, c, d) {
        c = c || 31104E3;
        this.remove(a);
        if (this.h)
            try {
    ...
    jh.prototype.get = function(a, b) {
        ...
        if (d && (c = fd.get("" + a, void 0)) && (c = unescape(c),
        b))
            try {
                c = JSON.parse(c)
            } catch (e) {
    ...
    jh.prototype.remove = function(a) {
        ...
        var b = this.i;
        fd.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    }
    ;
    var kh;
    function lh() {
        kh || (kh = new jh("yt.innertube"));
        return kh
    }
    function mh(a, b, c, d) {
        if (d)
        ...
        lh().set("nextId", d + 1, 86400, !0);
        lh().set("requests", e, 86400, !0);
        return d
    }
    function nh(a) {
        var b = lh().get("requests", !0) || {};
        delete b[a];
        lh().set("requests", b, 86400, !0)
    }
    function oh(a) {
        var b = lh().get("requests", !0);
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(P()) - d.requestTime)) {
                    var e = d.authState
                      , f = ih(hh(!1));
                    eb(e, f) && (e = d.request,
                    "requestTimeMs"in e && (e.requestTimeMs = Math.round(P())),
                    $g(a, d.method, e, {}));
                    delete b[c]
                }
            }
    ...
    function qh() {
        var a;
        return null === (a = ph()) || void 0 === a ? void 0 : a.get("LAST_RESULT_ENTRY_KEY", !0)
    }
    ;var rh = []
      , sh = !1;
    function th(a) {
    ...
    function xh() {
        if (void 0 !== N("DATASYNC_ID", void 0))
            return N("DATASYNC_ID", void 0);
        throw new vh("Datasync ID not set","unknown");
    }
    ;function yh(a) {
        if (0 <= a.indexOf(":"))
    ...
    ;var Q = {}
      , Ah = (Q.AUTH_INVALID = "No user identifier specified.",
    Q.EXPLICIT_ABORT = "Transaction was explicitly aborted.",
    Q.IDB_NOT_SUPPORTED = "IndexedDB is not supported.",
    Q.MISSING_INDEX = "Index not created.",
    Q.MISSING_OBJECT_STORES = "Object stores not created.",
    Q.DB_DELETED_BY_MISSING_OBJECT_STORES = "Database is deleted because expected object stores were not created.",
    Q.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.",
    Q.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.",
    Q.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.",
    Q.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database",
    Q.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version",
    Q)
      , R = {}
      , Bh = (R.AUTH_INVALID = "ERROR",
    R.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING",
    R.EXPLICIT_ABORT = "IGNORED",
    R.IDB_NOT_SUPPORTED = "ERROR",
    R.MISSING_INDEX = "WARNING",
    R.MISSING_OBJECT_STORES = "ERROR",
    R.DB_DELETED_BY_MISSING_OBJECT_STORES = "WARNING",
    R.QUOTA_EXCEEDED = "WARNING",
    R.QUOTA_MAYBE_EXCEEDED = "WARNING",
    R.UNKNOWN_ABORT = "WARNING",
    R.INCOMPATIBLE_DB_VERSION = "WARNING",
    R)
      , S = {}
      , Ch = (S.AUTH_INVALID = !1,
    S.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1,
    S.EXPLICIT_ABORT = !1,
    S.IDB_NOT_SUPPORTED = !1,
    S.MISSING_INDEX = !1,
    S.MISSING_OBJECT_STORES = !1,
    S.DB_DELETED_BY_MISSING_OBJECT_STORES = !1,
    S.QUOTA_EXCEEDED = !1,
    S.QUOTA_MAYBE_EXCEEDED = !0,
    S.UNKNOWN_ABORT = !0,
    S.INCOMPATIBLE_DB_VERSION = !1,
    S);
    ...
    w(Eh, Error);
    var Fh = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
    function Gh(a, b, c, d) {
        b = zh(b);
        ...
        if (jc && "UnknownError" === e.name)
            return new T("QUOTA_MAYBE_EXCEEDED",a);
        if (e instanceof Eh)
            return new T("MISSING_INDEX",Object.assign(Object.assign({}, a), {
                objectStore: e.objectStore,
                index: e.index
            }));
        if ("InvalidStateError" === e.name && Fh.some(function(f) {
    ...
    U.all = function(a) {
        return new U(new Kh(function(b, c) {
            var d = []
              , e = a.length;
            0 === e && b(d);
            for (var f = {
            ...
            ++f.Y)
                Lh(U.resolve(a[f.Y]).then(function(g) {
                    return function(h) {
                        d[g.Y] = h;
                        e--;
                        0 === e && b(d)
    ...
    U.prototype.then = function(a, b) {
        var c = this
          , d = null !== a && void 0 !== a ? a : Jh
          , e = null !== b && void 0 !== b ? b : Ih;
        return new U(new Kh(function(f, g) {
            "PENDING" === c.state.status ? (c.h.push(function() {
                Mh(c, c, d, f, g)
            }),
            c.onRejected.push(function() {
                Nh(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? Mh(c, c, d, f, g) : "REJECTED" === c.state.status && Nh(c, c, e, f, g)
        }
        ))
    }
    ;
    ...
    function Mh(a, b, c, d, e) {
        try {
            ...
            f instanceof U ? Oh(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    ;function Rh(a, b) {
        return new U(new Kh(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
    ...
    function W(a, b, c, d) {
        ...
        return z(function(A) {
            ...
            case 6:
                return n = A.i,
                p = Math.round(P()),
                Yh(a, k, p, g, void 0, b.join(), e),
                A.return(n);
            case 4:
                u = ua(A);
                q = Math.round(P());
                v = Gh(u, a.h.name, b.join(), a.h.version);
                if ((x = v instanceof T && !v.h) || g >= f)
                    Yh(a, k, q, g, v, b.join(), e),
                    h = v;
                A.o(2);
                break;
            case 3:
    ...
    function Yh(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof T && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && uh("QUOTA_EXCEEDED", {
            dbName: zh(a.h.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }),
        e instanceof T && "UNKNOWN_ABORT" === e.type && (c -= a.j,
        0 > c && c >= Math.pow(2, 31) && (c = 0),
        uh("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
        ...
        a.i = !0),
        Zh(a, !1, d, f, b, g.tag),
        th(e)) : Zh(a, !0, d, f, b, g.tag)
    }
    function Zh(a, b, c, d, e, f) {
        uh("TRANSACTION_ENDED", {
            objectStoreNames: d,
    ...
    m.delete = function(a) {
        return a instanceof IDBKeyRange ? $h(this, a) : V(this.h.delete(a))
    }
    ;
    m.get = function(a) {
    ...
    m.index = function(a) {
        try {
            return new bi(this.h.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name)
                throw new Eh(a,this.h.name);
            throw b;
        }
    }
    ;
    ...
    Wh.prototype.abort = function() {
        this.h.abort();
        this.i = !0;
        throw new T("EXPLICIT_ABORT");
    }
    ;
    Wh.prototype.objectStore = function(a) {
    ...
    function ci(a) {
        return V(a).then(function(b) {
            return b ? new ei(a,b) : null
        })
    }
    m = ei.prototype;
    m.advance = function(a) {
        this.cursor.advance(a);
        return ci(this.request)
    }
    ;
    ...
    function fi(a, b, c) {
        return new Promise(function(d, e) {
            ...
            var h = c.blocked, k = c.blocking, l = c.ub, n = c.upgrade, p = c.closed, u;
            g.addEventListener("upgradeneeded", function(q) {
                try {
                    ...
                    q.dataLoss && "none" !== q.dataLoss && uh("IDB_DATA_CORRUPTED", {
                        reason: q.dataLossMessage || "unknown reason",
                        dbName: zh(a)
                    });
                    var v = f()
                      , x = new Wh(g.transaction);
                    n && n(v, function(A) {
                        return q.oldVersion < A && q.newVersion >= A
                    }, x);
                    x.done.catch(function(A) {
                        e(A)
                    })
                } catch (A) {
                    e(A)
    ...
    ;
    ji.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return hi(this.name, a)
    }
    ;
    function ki(a, b) {
    ...
    function li(a, b) {
        if (!b)
            throw Hh("openWithToken", zh(a.name));
        return a.open()
    }
    ji.prototype.open = function() {
        function a() {
            var f, g, h, k, l, n, p, u, q, v;
            return z(function(x) {
                switch (x.h) {
                case 1:
                    return h = null !== (f = Error().stack) && void 0 !== f ? f : "",
                    sa(x, 2),
                    y(x, c.j(c.name, c.options.version, e), 4);
                case 4:
                    k = x.i;
                    for (var A = c.options, J = [], K = t(Object.keys(A.ha)), M = K.next(); !M.done; M = K.next()) {
                        M = M.value;
                        var Cb = A.ha[M]
                          , Id = void 0 === Cb.tb ? Number.MAX_VALUE : Cb.tb;
                        !(k.h.version >= Cb.ya) || k.h.version >= Id || k.h.objectStoreNames.contains(M) || J.push(M)
                    }
                    l = J;
                    if (0 === l.length) {
                        x.o(5);
                    ...
                    n = Object.keys(c.options.ha);
                    p = k.objectStoreNames();
                    if (!(c.m < Uf("ytidb_remake_db_retries", 1))) {
                        x.o(6);
                        break
                    }
                    c.m++;
                ...
                case 8:
                    c.i *= 2;
                case 7:
                    return y(x, c.delete(), 9);
                case 9:
                    return th(new T("DB_DELETED_BY_MISSING_OBJECT_STORES",{
                        dbName: c.name,
                ...
                case 2:
                    ...
                    return y(x, c.j(c.name, void 0, Object.assign(Object.assign({}, e), {
                        upgrade: void 0
                    })), 11);
                case 11:
                    q = x.i;
                    v = q.h.version;
                    if (void 0 !== c.options.version && v > c.options.version + 1)
                        throw q.close(),
                        c.l = !1,
                        ki(c, v);
                    return x.return(q);
                case 10:
                    throw b(),
                    u instanceof Error && !O("ytidb_async_stack_killswitch") && (u.stack = u.stack + "\n" + h.substring(h.indexOf("\n") + 1)),
                    Gh(u, c.name, "", null !== (g = c.options.version) && void 0 !== g ? g : -1);
                }
            })
        }
        function b() {
    ...
    function ni(a, b) {
        ...
        return z(function(d) {
            if (1 == d.h)
                return y(d, li(mi, b), 2);
            c = d.i;
            return d.return(W(c, ["databases"], {
                G: !0,
                mode: "readwrite"
            }, function(e) {
                ...
                return f.get(a.actualName).then(function(g) {
                    if (g ? a.actualName !== g.actualName || a.publicName !== g.publicName || a.userIdentifier !== g.userIdentifier : 1)
                        return V(f.h.put(a, void 0)).then(function() {})
                })
            }))
        })
    }
    function oi(a, b) {
        ...
        return z(function(d) {
            if (1 == d.h)
                return a ? y(d, li(mi, b), 2) : d.return();
            c = d.i;
    ...
    function pi(a, b) {
        ...
        return z(function(e) {
            return 1 == e.h ? (c = [],
            y(e, li(mi, b), 2)) : 3 != e.h ? (d = e.i,
            y(e, W(d, ["databases"], {
                G: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
                return ai(f.objectStore("databases"), {}, function(g) {
    ...
    function ti() {
        ...
        return z(function(d) {
            ...
            case 1:
                ...
                var e;
                if (e = ug)
                    e = /WebKit\/([0-9]+)/.exec(Bb),
                    e = !!(e && 600 <= parseInt(e[1], 10));
                e && (e = /WebKit\/([0-9]+)/.exec(Bb),
                ...
                return y(d, ni(c, si), 4);
            case 4:
                return y(d, oi("yt-idb-test-do-not-use", si), 5);
            case 5:
                return d.return(!0);
            case 2:
                return ua(d),
    ...
    function ui() {
        if (void 0 !== ri)
            return ri;
        sh = !0;
        return ri = ti().then(function(a) {
            sh = !1;
            var b, c;
            null !== (b = ph()) && void 0 !== b && b.h && (b = qh(),
            b = {
                hasSucceededOnce: (null === b || void 0 === b ? void 0 : b.hasSucceededOnce) || a
            },
            null === (c = ph()) || void 0 === c ? void 0 : c.set("LAST_RESULT_ENTRY_KEY", b, 2592E3, !0));
            return a
        })
    }
    function vi() {
    ...
    function wi() {
        var a = vi();
        return a ? Promise.resolve(a) : ui().then(function(b) {
            (b = b ? si : void 0) && E("ytglobal.idbToken_", b);
            return b
        })
    }
    ;new function() {
    ...
    function yi(a, b, c, d) {
        ...
        return z(function(n) {
            switch (n.h) {
            case 1:
                return f = null !== (e = Error().stack) && void 0 !== e ? e : "",
                y(n, wi(), 2);
            case 2:
                g = n.i;
                if (!g)
                    throw h = Hh("openDbImpl", a, b),
                ...
                return y(n, ni(k, g), 5);
            case 5:
                return y(n, gi(k.actualName, b, d), 6);
            case 6:
                return n.return(n.i);
            case 3:
                return l = ua(n),
                sa(n, 7),
                y(n, oi(k.actualName, g), 9);
            case 9:
                ta(n, 8);
                break;
            case 7:
    ...
    function Bi(a, b) {
        ...
        return z(function(e) {
            ...
            if (3 != e.h) {
                ...
                yh(a);
                d = xi(a);
                return y(e, hi(d.actualName, b), 3)
            }
            return y(e, oi(d.actualName, c), 0)
        })
    }
    function Ci(a, b, c) {
        a = a.map(function(d) {
            return z(function(e) {
                return 1 == e.h ? y(e, hi(d.actualName, b), 2) : y(e, oi(d.actualName, c), 0)
            })
        });
    ...
    ;function Fi(a) {
        ...
        this.now = Date.now;
        this.da = !1;
        this.ab = null !== (b = a.ab) && void 0 !== b ? b : 100;
        ...
        this.ta = null !== (k = a.ta) && void 0 !== k ? k : 10;
        ...
        this.Fa = a.Fa;
        this.Ea = a.Ea;
        this.s && (!this.B || this.B("networkless_logging")) && Gi(this)
    }
    function Gi(a) {
        z(function(b) {
            if (1 == b.h)
                return !a.s || a.da ? b.return() : a.pa && Math.random() <= a.oa ? y(b, a.C.ib(a.s), 2) : b.o(2);
            Hi(a);
            a.F.D() && a.ja();
            a.F.X(a.Fa, a.ja.bind(a));
            a.F.X(a.Ea, a.Ja.bind(a));
            a.h = !0;
            b.h = 0
        })
    }
    ...
    m.writeThenSend = function(a, b) {
        ...
        if (this.s && this.h) {
            ...
            this.C.set(d, this.s).then(function(e) {
                d.id = e;
                c.F.D() && Ii(c, d)
            }).catch(function(e) {
                Ii(c, d);
    ...
    m.sendThenWrite = function(a, b, c) {
        ...
        if (this.s && this.h) {
            ...
            if (this.F.D() || this.B && this.B("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    ...
                    b.onError = function(g, h) {
                        return z(function(k) {
                            if (1 == k.h)
                                return y(k, d.C.set(e, d.s).catch(function(l) {
                                    Ji(d, l)
                                }), 2);
                            f(g, h);
                            k.h = 0
                ...
                this.C.set(e, this.s).catch(function(g) {
                    d.P(a, b, e.skipRetry);
                    Ji(d, g)
                })
        } else
            this.P(a, b, this.B && this.B("nwl_skip_retry") && c)
    }
    ;
    m.sendAndWrite = function(a, b) {
        ...
        if (this.s && this.h) {
            ...
            d.options.onSuccess = function(g, h) {
                void 0 !== d.id ? c.C.Z(d.id, c.s) : e = !0;
                c.F.V && c.B && c.B("vss_network_hint") && c.F.V(!0);
                f(g, h)
            }
            ;
            this.P(d.url, d.options);
            this.C.set(d, this.s).then(function(g) {
                d.id = g;
                e && c.C.Z(d.id, c.s)
            }).catch(function(g) {
                Ji(c, g)
    ...
    m.ja = function() {
        var a = this;
        if (!this.s)
            throw Hh("throttleSend");
        this.i || (this.i = this.J.K(function() {
            var b;
            return z(function(c) {
                if (1 == c.h)
                    return y(c, a.C.Pa("NEW", a.s), 2);
                if (3 != c.h)
                    return b = c.i,
                    b ? y(c, Ii(a, b), 3) : (a.Ja(),
                    c.return());
    ...
    function Ii(a, b) {
        ...
        return z(function(e) {
            ...
            case 1:
                if (!a.s)
                    throw c = Hh("immediateSend"),
                    c;
                if (void 0 === b.id) {
                    e.o(2);
                    break
                }
                return y(e, a.C.rb(b.id, a.s), 3);
            case 3:
                (d = e.i) ? b = d : a.aa(Error("The request cannot be found in the database."));
            case 2:
                if (Ki(a, b, a.Wa)) {
                    e.o(4);
                    break
                ...
                return y(e, a.C.Z(b.id, a.s), 5);
            case 5:
                return e.return();
            case 4:
                b.skipRetry || (b = Li(a, b));
                if (!b) {
                    e.o(0);
                    break
                }
                ...
                return y(e, a.C.Z(b.id, a.s), 8);
            case 8:
                a.P(b.url, b.options, !!b.skipRetry),
                e.h = 0
            }
        })
    }
    function Li(a, b) {
        if (!a.s)
            throw Hh("updateRequestHandlers");
        ...
        b.options.onError = function(e, f) {
            ...
            return z(function(h) {
                ...
                case 3:
                    ...
                    return y(h, a.C.Ga(b.id, a.s, !1), 6);
                case 6:
                    return h.return();
                case 2:
                    if (a.B && a.B("nwl_consider_error_code") && !g && a.potentialEsfErrorCounter > a.ta)
                        return h.return();
                    ...
                    return b.sendCount < a.Ya ? y(h, a.C.Ga(b.id, a.s), 12) : y(h, a.C.Z(b.id, a.s), 8);
                case 12:
                    a.J.K(function() {
                        a.F.D() && a.ja()
                    }, a.Xa);
        ...
        b.options.onSuccess = function(e, f) {
            return z(function(g) {
                if (1 == g.h)
                    return void 0 === (null === b || void 0 === b ? void 0 : b.id) ? g.o(2) : y(g, a.C.Z(b.id, a.s), 2);
                a.F.V && a.B && a.B("vss_network_hint") && a.F.V(!0);
                d(e, f);
                g.h = 0
            })
        }
    ...
    function Hi(a) {
        if (!a.s)
            throw Hh("retryQueuedRequests");
        a.C.Pa("QUEUED", a.s).then(function(b) {
            b && !Ki(a, b, a.Va) ? a.J.K(function() {
                return z(function(c) {
                    if (1 == c.h)
                        return void 0 === b.id ? c.o(2) : y(c, a.C.Ga(b.id, a.s), 2);
                    Hi(a);
                    c.h = 0
                })
            }) : a.F.D() && a.ja()
    ...
    function Ji(a, b) {
        a.bb && !a.F.D() ? a.bb(b) : a.handleError(b)
    }
    function Mi(a) {
        var b;
        return (a = null === (b = null === a || void 0 === a ? void 0 : a.error) || void 0 === b ? void 0 : b.code) && 400 <= a && 599 >= a ? !1 : !0
    }
    ;var Ni = C("ytPubsub2Pubsub2Instance") || new L;
    L.prototype.subscribe = L.prototype.subscribe;
    L.prototype.unsubscribeByKey = L.prototype.ka;
    L.prototype.publish = L.prototype.ba;
    L.prototype.clear = L.prototype.clear;
    E("ytPubsub2Pubsub2Instance", Ni);
    ...
    Oi.prototype.j = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.Ha ? Ai : zi)(a, b, Object.assign({}, c))
    }
    ;
    Oi.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.Ha ? Ei : Bi)(this.name, a)
    }
    ;
    function Qi(a, b) {
        return Pi(a, b)
    ...
    function Si() {
        if (Ri)
            return Ri();
        var a = {};
        Ri = Qi("LogsDatabaseV2", {
            ha: (a.LogsRequestsStore = {
                ya: 2
            },
            a),
            Ha: !1,
            upgrade: function(b, c, d) {
                c(2) && Th(b, "LogsRequestsStore", {
                    keyPath: "id",
                    autoIncrement: !0
                });
                c(3);
                ...
                d.h.createIndex("newRequestV2", ["status", "interface", "timestamp"], {
                    unique: !1
                }));
    ...
    function Wi(a, b) {
        ...
        return z(function(l) {
            ...
            if (3 != l.h)
                ...
                k = void 0,
                y(l, W(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    G: !0
                }, function(n) {
                    return di(n.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        query: h,
                        direction: "prev"
                    }, function(p) {
                        p.cursor.value && (k = p.cursor.value,
    ...
    function Xi(a, b) {
        ...
        return z(function(d) {
            if (1 == d.h)
                return y(d, Ti(b), 2);
            c = d.i;
            return d.return(W(c, ["LogsRequestsStore"], {
                mode: "readwrite",
                G: !0
            }, function(e) {
                ...
                return f.get(a).then(function(g) {
                    if (g)
                        ...
                        V(f.h.put(g, void 0)).then(function() {
                            return g
                        })
                })
            }))
    ...
    function Yi(a, b, c) {
        ...
        return z(function(e) {
            if (1 == e.h)
                return y(e, Ti(b), 2);
            d = e.i;
            return e.return(W(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                G: !0
            }, function(f) {
                ...
                return g.get(a).then(function(h) {
                    ...
                    c && (h.sendCount += 1),
                    V(g.h.put(h, void 0)).then(function() {
                        return h
                    })) : U.resolve(void 0)
                })
            }))
    ...
    function $i(a) {
        ...
        return z(function(d) {
            ...
            b = d.i;
            c = P() - 2592E6;
            return y(d, W(b, ["LogsRequestsStore"], {
                mode: "readwrite",
                G: !0
            }, function(e) {
                return ai(e.objectStore("LogsRequestsStore"), {}, function(f) {
    ...
    ;var bj = {}
      , cj = Qi("ServiceWorkerLogsDatabase", {
        ha: (bj.SWHealthLog = {
            ya: 1
        },
        bj),
    ...
    function ej(a) {
        ...
        z(function(d) {
            ...
            b = d.i;
            c = P() - 2592E6;
            return y(d, W(b, ["SWHealthLog"], {
                mode: "readwrite",
                G: !0
            }, function(e) {
                return ai(e.objectStore("SWHealthLog"), {}, function(f) {
                    if (f.cursor.value.timestamp <= c)
                        return f.delete().then(function() {
                            return f.continue()
                        })
    ...
    function fj(a) {
        ...
        return z(function(c) {
            if (1 == c.h)
                return y(c, dj(a), 2);
            b = c.i;
            return y(c, b.clear("SWHealthLog"), 0)
        })
    }
    ;var hj;
    function ij() {
        hj || (hj = new jh("yt.offline"));
        return hj
    }
    function jj(a) {
        if (O("offline_error_handling")) {
            var b = ij().get("errors", !0) || {};
            b[a.message] = {
                name: a.name,
                stack: a.stack
            };
            a.level && (b[a.message].level = a.level);
            ij().set("errors", b, 2592E3, !0)
        }
    }
    function kj() {
        if (O("offline_error_handling")) {
            var a = ij().get("errors", !0);
            if (a) {
                for (var b in a)
                    if (a[b]) {
                        var c = new vh(b,"sent via offline_errors");
                        c.name = a[b].name;
                        c.stack = a[b].stack;
                        c.level = a[b].level;
                        yf(c)
                    }
                ij().set("errors", {}, 2592E3, !0)
            }
        }
    }
    ;var lj = Uf("network_polling_interval", 3E4);
    function X() {
        I.call(this);
        this.N = 0;
        this.la = this.m = !1;
        this.j = this.Aa();
        O("use_shared_nsm") ? (Rd.h || (Rd.h = new Rd(cg)),
        this.i = Rd.h) : (mj(this),
        nj(this))
    }
    w(X, I);
    function oj() {
        if (!X.h) {
            var a = C("yt.networkStatusManager.instance") || new X;
    ...
    m.D = function() {
        var a;
        return O("use_shared_nsm") && this.i ? null === (a = this.i) || void 0 === a ? void 0 : a.D() : this.j
    }
    ;
    m.V = function(a) {
        var b;
        O("use_shared_nsm") && this.i ? null === (b = this.i) || void 0 === b ? void 0 : b.i = a : a !== this.j && (this.j = a)
    }
    ;
    m.sb = function(a) {
        !O("use_shared_nsm") && (this.m = !0,
        void 0 === a ? 0 : a) && (this.N || pj(this))
    }
    ;
    m.Aa = function() {
    ...
    ;
    m.X = function(a, b) {
        return O("use_shared_nsm") && this.i ? this.i.X(a, b) : I.prototype.X.call(this, a, b)
    }
    ;
    function nj(a) {
    ...
    function pj(a) {
        a.N = Yf(function() {
            return z(function(b) {
                if (1 == b.h)
                    return a.j ? a.Aa() || !a.m ? b.o(3) : y(b, a.R(), 3) : y(b, a.R(), 3);
                pj(a);
                b.h = 0
            })
        }, lj)
    ...
    m.R = function(a) {
        var b = this;
        return O("use_shared_nsm") && this.i ? Sd(this.i, a) : this.u ? this.u : this.u = new Promise(function(c) {
            var d, e, f;
            return z(function(g) {
                switch (g.h) {
                case 1:
                ...
                case 3:
                    ...
                    b.A && cg.W(b.A);
                    f !== b.j && (b.j = f,
                    b.j && b.m ? Pd(b, "ytnetworkstatus-online") : b.m && Pd(b, "ytnetworkstatus-offline"));
                    c(f);
                    wa(g);
                    break;
                case 2:
    ...
    ;
    X.prototype.sendNetworkCheckRequest = X.prototype.R;
    X.prototype.listen = X.prototype.X;
    X.prototype.enableErrorFlushing = X.prototype.kb;
    X.prototype.getWindowStatus = X.prototype.Aa;
    X.prototype.monitorNetworkStatusChange = X.prototype.sb;
    X.prototype.networkStatusHint = X.prototype.V;
    X.prototype.isNetworkAvailable = X.prototype.D;
    X.getInstance = oj;
    function qj(a) {
        a = void 0 === a ? {} : a;
        I.call(this);
        ...
        c && c(a.Ma);
        a.ra && !O("use_shared_nsm") && (c = C("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i)) && c();
        if (c = C("yt.networkStatusManager.instance.listen").bind(this.i))
            a.va ? (this.va = a.va,
            c(this.u, function() {
                rj(b, "publicytnetworkstatus-online");
                O("use_shared_nsm") && a.ra && kj()
            }),
            c(this.m, function() {
                rj(b, "publicytnetworkstatus-offline")
            })) : (c(this.u, function() {
    ...
    qj.prototype.D = function() {
        var a = C("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.i);
        return a ? a() : !0
    }
    ;
    ...
    ;
    qj.prototype.R = function(a) {
        var b = this, c;
        return z(function(d) {
            return (c = C("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.i)) ? d.return(c(a)) : d.return(!0)
        })
    }
    ;
    function rj(a, b) {
    ...
    function tj() {
        Fi.call(this, {
            ...
            pa: !0,
            oa: .1,
            ta: Uf("potential_esf_error_limit", 10),
            B: O,
            da: !wh()
        });
        this.pa && Math.random() <= this.oa && this.s && ej(this.s);
        O("networkless_immediately_drop_sw_health_store") && wj(this);
        O("networkless_immediately_drop_all_requests") && aj();
        Ei("LogsDatabaseV2")
    }
    w(tj, Fi);
    function xj() {
        ...
        O("networkless_logging") && wi().then(function(b) {
            a.s = b;
            Gi(a)
        }));
        return a
    }
    tj.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        wh() || (this.h = !1);
        Fi.prototype.writeThenSend.call(this, a, b)
    }
    ;
    tj.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        wh() || (this.h = !1);
        Fi.prototype.sendThenWrite.call(this, a, b, c)
    }
    ;
    tj.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        wh() || (this.h = !1);
        Fi.prototype.sendAndWrite.call(this, a, b)
    }
    ;
    function wj(a) {
        var b;
        z(function(c) {
            if (!a.s)
                throw b = Hh("clearSWHealthLogsDb"),
                b;
            return c.return(fj(a.s).catch(function(d) {
                a.handleError(d)
            }))
        })
    }
    function vj(a, b, c) {
        ...
        if (null === (d = b.postParams) || void 0 === d ? 0 : d.requestTimeMs)
            b.postParams.requestTimeMs = Math.round(P());
        c && 0 === Object.keys(b).length ? yg(a) : mg(a, b)
    }
    function uj() {
        sj || (sj = new qj({
            ra: !0,
    ...
    ;var yj = 0, zj = 0, Aj, Bj = B.ytNetworklessLoggingInitializationOptions || {
        isNwlInitialized: !1,
        potentialEsfErrorCounter: zj
    };
    E("ytNetworklessLoggingInitializationOptions", Bj);
    function Cj(a, b) {
        function c(d) {
            var e = Dj().D();
            if (!Ej() || !d || e && O("vss_networkless_bypass_write"))
                Fj(a, b);
            else {
                var f = {
                    url: a,
        ...
        b = void 0 === b ? {} : b;
        O("skip_is_supported_killswitch") ? wi().then(function(d) {
            c(d)
        }) : c(vi())
    }
    function Hj(a, b) {
        function c(d) {
            if (Ej() && d) {
                ...
                e.options.onSuccess = function(h, k) {
                    void 0 !== e.id ? Zi(e.id, d) : f = !0;
                    O("vss_network_hint") && Dj().V(!0);
                    g(h, k)
                }
                ;
                Fj(e.url, e.options);
                Ui(e, d).then(function(h) {
                    e.id = h;
                    f && Zi(e.id, d)
                }).catch(function(h) {
                    Dj().D() ? yf(h) : jj(h)
    ...
    function Ij() {
        ...
        yj || (yj = cg.K(function() {
            ...
            return z(function(c) {
                if (1 == c.h)
                    return y(c, Wi("NEW", a), 2);
                if (3 != c.h)
                    return b = c.i,
                    b ? y(c, Gj(b), 3) : (cg.W(yj),
                    yj = 0,
                    c.return());
                yj && (yj = 0,
                Ij());
    ...
    function Gj(a) {
        ...
        return z(function(e) {
            ...
            case 1:
                ...
                return y(e, Xi(a.id, b), 3);
            case 3:
                (d = e.i) ? a = d : zf(Error("The request cannot be found in the database."));
            case 2:
                var f = a.timestamp;
                if (!(2592E6 <= P() - f)) {
                    e.o(4);
                ...
                zf(Error("Networkless Logging: Stored logs request expired age limit"));
                if (void 0 === a.id) {
                    e.o(5);
                    break
                }
                return y(e, Zi(a.id, b), 5);
            case 5:
                return e.return();
            case 4:
                a.skipRetry || (a = Jj(a));
                f = a;
                var g, h;
                if (null === (h = null === (g = null === f || void 0 === f ? void 0 : f.options) || void 0 === g ? void 0 : g.postParams) || void 0 === h ? 0 : h.requestTimeMs)
                    f.options.postParams.requestTimeMs = Math.round(P());
                a = f;
                if (!a) {
                    e.o(0);
                    break
                ...
                return y(e, Zi(a.id, b), 8);
            case 8:
                Fj(a.url, a.options, !!a.skipRetry),
                e.h = 0
            }
        })
    }
    function Jj(a) {
        ...
        a.options.onError = function(e, f) {
            ...
            return z(function(h) {
                ...
                case 1:
                    g = Mi(f);
                    if (!(O("nwl_consider_error_code") && g || !O("nwl_consider_error_code") && Kj() <= Uf("potential_esf_error_limit", 10))) {
                        h.o(2);
                        break
                    }
                    return y(h, Dj().R(), 3);
                case 3:
                    ...
                    c(e, f);
                    if (!O("nwl_consider_error_code") || void 0 === (null === a || void 0 === a ? void 0 : a.id)) {
                        h.o(5);
                        break
                    }
                    return y(h, Yi(a.id, b, !1), 5);
                case 5:
                    return h.return();
                case 2:
                    if (O("nwl_consider_error_code") && !g && Kj() > Uf("potential_esf_error_limit", 10))
                        return h.return();
                    C("ytNetworklessLoggingInitializationOptions") && Bj.potentialEsfErrorCounter++;
                    zj++;
                    if (void 0 === (null === a || void 0 === a ? void 0 : a.id)) {
                        h.o(7);
                        break
                    }
                    return 1 > a.sendCount ? y(h, Yi(a.id, b), 11) : y(h, Zi(a.id, b), 7);
                case 11:
                    cg.K(function() {
                        Dj().D() && Ij()
                    }, 5E3);
        ...
        a.options.onSuccess = function(e, f) {
            return z(function(g) {
                if (1 == g.h)
                    return void 0 === (null === a || void 0 === a ? void 0 : a.id) ? g.o(2) : y(g, Zi(a.id, b), 2);
                O("vss_network_hint") && Dj().V(!0);
                d(e, f);
                g.h = 0
            })
    ...
    function Ej() {
        return C("ytNetworklessLoggingInitializationOptions") ? Bj.isNwlInitialized : !1
    }
    function Kj() {
        return C("ytNetworklessLoggingInitializationOptions") ? Bj.potentialEsfErrorCounter : zj
    }
    ;function Lj(a) {
        var b = this;
        this.config_ = null;
        a ? this.config_ = a : gh() && (this.config_ = Xg());
        Yf(function() {
            oh(b)
        }, 5E3)
    }
    Lj.prototype.isReady = function() {
        !this.config_ && gh() && (this.config_ = Xg());
        return !!this.config_
    }
    ;
    function $g(a, b, c, d) {
        function e(v) {
            v = void 0 === v ? !1 : v;
            var x;
            if (d.retry && "www.youtube-nocookie.com" != h && (v || O("skip_ls_gel_retry") || (x = mh(b, c, l, k)),
            x)) {
                var A = g.onSuccess
                  , J = g.onFetchSuccess;
                g.onSuccess = function(K, M) {
                    nh(x);
                    A(K, M)
                }
                ;
                c.onFetchSuccess = function(K, M) {
                    nh(x);
                    J(K, M)
                }
            }
            try {
                v && d.retry && !d.Ta.bypassNetworkless ? (g.method = "POST",
                d.Ta.writeThenSend ? O("use_new_nwl") ? xj().writeThenSend(q, g) : Cj(q, g) : O("use_new_nwl") ? xj().sendAndWrite(q, g) : Hj(q, g)) : (g.method = "POST",
                ...
                if ("InvalidAccessError" == K.name)
                    x && (nh(x),
                    x = 0),
                    zf(Error("An extension is blocking network request."));
                else
                    throw K;
            }
            x && Yf(function() {
        ...
        !N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && zf(new vh("Missing VISITOR_DATA when sending innertube request.",b,c,d));
        if (!a.isReady()) {
            var f = new vh("innertube xhrclient not ready",b,c,d);
            yf(f);
            throw f;
        }
        var g = {
        ...
        var n = "/youtubei/" + a.config_.innertubeApiVersion + "/" + b
          ...
          , u = a.config_.pb && f;
        O("omit_innertube_api_key_for_bearer_auth_header") && (u = u && f.startsWith("Bearer"));
        u || (p.key = a.config_.innertubeApiKey);
        var q = Rf("" + h + n, p || {}, !0);
        O("use_new_nwl") || Ej() ? ui().then(function(v) {
            e(v)
        }) : e(!1)
    }
    ;function Mj(a, b) {
        var c = void 0 === c ? {} : c;
        var d = Lj;
        N("ytLoggingEventsDefaultDisabled", !1) && Lj == Lj && (d = null);
        a: {
            c = void 0 === c ? {} : c;
            if (O("lr_drop_other_and_business_payloads")) {
                if (Wf[a] || Vf[a])
                    break a
            } else if (O("lr_drop_other_payloads") && Wf[a])
                break a;
            var e = {}
              , f = Math.round(c.timestamp || P());
            ...
            O("log_sequence_info_on_gel_web") && c.Za && (a = e.context,
            b = c.Za,
            bh[b] = b in bh ? bh[b] + 1 : 0,
            a.sequence = {
                index: bh[b],
                groupKey: b
            },
    ...
    function Sj() {
        if (!Rj) {
            ...
            a.U.length = 0;
            a.T.length = 0;
            Pj.U && a.U.push.apply(a.U, Pj.U);
            Pj.T && a.T.push.apply(a.T, Pj.T)
        }
        return Rj
    }
    ;var Tj = new L;
    ...
    ;function Wj(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Xj(d, a[d], b, c),
                500 < e)); d++)
                    ;
                d = e
                ...
                for (e in a) {
                    if (a[e]) {
                        ...
                        var g = b;
                        var h = c;
                        g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = Uj(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? Xj(e + ".ve", f, g, h) : 0;
                        d += g;
                        d += Xj(e, a[e], b, c);
                        if (500 < d)
                            break
    ...
    ;var Zj = new Set
      ...
      , ck = 0
      , dk = []
      , ek = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
    var fk = {};
    function gk(a) {
    ...
    ;var hk = {}
      ...
      , jk = {};
    function kk() {
        for (var a = t(ik), b = a.next(); !b.done; b = a.next())
            b = b.value,
            b()
    }
    function lk(a, b) {
        var c;
        "yt:" === a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[gk(b)] : a.getAttribute("data-" + b) : null;
        return c
    }
    function mk(a) {
        Ue.ba.apply(Ue, arguments)
    }
    ;function nk(a) {
        this.h = a || {};
    ...
    function ok(a, b, c) {
        pk || (pk = {},
        Hf(window, "message", function(d) {
            a: {
                if (d.origin === Y(a, "host")) {
                    try {
    ...
    m.destroy = function() {
        this.h && this.h.id && (hk[this.h.id] = null);
        (0,
        jd)(this.l);
        if (this.m) {
            var a = this.h
    ...
    function vk(a, b) {
        ...
        c.setAttribute("title", "YouTube " + Y(a.i, "title"));
        (b = Y(a.i, "width")) && c.setAttribute("width", b.toString());
        (b = Y(a.i, "height")) && c.setAttribute("height", b.toString());
        var g = a.La();
        g.enablejsapi = window.postMessage ? 1 : 0;
        window.location.host && (g.origin = window.location.protocol + "//" + window.location.host);
        g.widgetid = a.id;
        window.location.href && G(["debugjs", "debugcss"], function(h) {
            var k = Qb(window.location.href, h);
            null !== k && (g[h] = k)
        });
        window.yt_embedsTokenValue && (g.embedsTokenValue = encodeURIComponent(window.yt_embedsTokenValue),
        delete window.yt_embedsTokenValue);
        c.src = Y(a.i, "host") + ("/embed/" + Y(a.i, "videoId")) + "?" + Ob(g);
        return c
    }
    m.Ua = function() {
    ...
    m.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            ...
            a = b),
            this.h = a,
            this.h.id || (this.h.id = "widget" + La(this.h)),
            hk[this.h.id] = this,
            window.postMessage) {
                this.l = new L;
                wk(this);
                ...
                for (var e in jk)
                    jk.hasOwnProperty(e) && tk(this, e)
            }
    }
    ;
    function sk(a, b) {
        a.H[b] || (a.H[b] = !0,
        uk(a, "addEventListener", [b]))
    }
    m.sendMessage = function(a) {
        a.id = this.id;
        a.channel = "widget";
        a = Ce(a);
        var b = [Mb(this.h.src || "").replace("http:", "https:")];
                        ...
                        if (!(A.message && 0 < A.message.indexOf("target origin ''"))) {
                            ...
                            if (e) {
                                ...
                                if (!(5 <= ak)) {
                                    ...
                                    var n = l.stack || e.i || "Not available";
                                    if (n.startsWith(h + ": " + f)) {
                                        var p = n.split("\n");
                                        p.shift();
                                        n = p.join("\n")
                                    ...
                                    if (e.hasOwnProperty("args") && e.args && e.args.length)
                                        for (g = 0; g < e.args.length && !(u = Wj(e.args[g], "params." + g, k, u),
                                        500 <= u); g++)
                                            ;
                                    ...
                                    if (dk.length)
                                        for (g = 0; g < dk.length && !(u = Wj(dk[g], "params.context." + g, k, u),
                                        500 <= u); g++)
                                            ;
                                    ...
                                    if ("IGNORED" === e.level)
                                        ...
                                        a: {
                                            ...
                                            for (h = f.next(); !h.done; h = f.next())
                                                if (h = h.value,
                                                g.message && g.message.match(h.Pb)) {
                                                    e = h.weight;
                                                    break a
                                                }
                                            e = t(e.T);
                                    ...
                                    for (f = g.next(); !f.done; f = g.next())
                                        ...
                                        f.sa[e.name])
                                            ...
                                            h = p.next(); !h.done; h = p.next())
                                                if (l = h.value,
                                                h = e.message.match(l.regexp)) {
                                                    e.params["params.error.original"] = h[0];
                                                    p = l.groups;
                                                    l = {};
                                                    for (n = 0; n < p.length; n++)
                                                        l[p[n]] = h[n + 1],
                                                        e.params["params.error." + p[n]] = h[n + 1];
                                                    e.message = f.Da(l);
                                                    break
                                                }
                                    e.params || (e.params = {});
                                    g = Sj();
                                    e.params["params.errorServiceSignature"] = "msg=" + g.U.length + "&cb=" + g.T.length;
                                    ...
                                    lb("sample").constructor !== jb && (e.params["params.fconst"] = "true");
                                    window.yterr && "function" === typeof window.yterr && window.yterr(e);
                                    if (0 !== e.sampleWeight && !Zj.has(e.message)) {
                                        "ERROR" === d ? (Tj.ba("handleError", e),
                                        O("record_app_crashed_web") && 0 === ck && 1 === e.sampleWeight && (ck++,
                                        Mj("appCrashed", {
                                            appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                                        })),
                                        bk++) : "WARNING" === d && Tj.ba("handleWarning", e);
                                        if (O("kevlar_gel_error_routing")) {
                                            ...
                                            if (f)
                                                ...
                                                h.fileName && (p.filename = h.fileName);
                                                f = h.lineNumber && h.lineNumber.split ? h.lineNumber.split(":") : [];
                                                0 !== f.length && (1 !== f.length || isNaN(Number(f[0])) ? 2 !== f.length || isNaN(Number(f[0])) || isNaN(Number(f[1])) || (p.lineNumber = Number(f[0]),
                                                p.columnNumber = Number(f[1])) : p.lineNumber = Number(f[0]));
                                                f = {
                                                ...
                                                "ERROR" === g ? f.level = "ERROR_LEVEL_ERROR" : "WARNING" === g && (f.level = "ERROR_LEVEL_WARNNING");
                                                p = {
                                                    isObfuscated: !0,
                                                    browserStackInfo: p
                                                };
                                                ...
                                                N("FEXP_EXPERIMENTS") && (l.experimentIds = N("FEXP_EXPERIMENTS"));
                                                n = uf();
                                                k = (k = qf.EXPERIMENT_FLAGS) ? k.web_disable_gel_stp_ecatcher_killswitch : void 0;
                                                if (!k && n)
                                                    for (u = t(Object.keys(n)),
                                                    k = u.next(); !k.done; k = u.next())
                                                        k = k.value,
                                                        l.kvPairs.push({
                                                            key: k,
                                                            value: String(n[k])
                                                ...
                                                if (h = h.params)
                                                    for (n = t(Object.keys(h)),
                                                    k = n.next(); !k.done; k = n.next())
                                                        k = k.value,
                                                        l.kvPairs.push({
                                                            key: "client." + k,
                                                            value: String(h[k])
                                                        });
                                                h = N("SERVER_NAME", void 0);
                                                n = N("SERVER_VERSION", void 0);
                                                h && n && (l.kvPairs.push({
                                                    key: "server.name",
                                                    value: h
                                                }),
                                            ...
                                            f && (Mj("clientError", f),
                                            ("ERROR" === g || O("errors_flush_gel_always_killswitch")) && Sg())
                                        }
                                        if (!O("suppress_error_204_logging")) {
                                            ...
                                            if (d.postParams) {
                                                ...
                                                for (h = f.next(); !h.done; h = f.next())
                                                    h = h.value,
                                                    d.postParams["client." + h] = g[h];
                                                if (g = uf())
                                                    for (f = t(Object.keys(g)),
                                                    h = f.next(); !h.done; h = f.next())
                                                        h = h.value,
                                                        d.postParams[h] = g[h];
                                                g = N("SERVER_NAME", void 0);
                                                f = N("SERVER_VERSION", void 0);
                                                g && f && (d.postParams["server.name"] = g,
                                                d.postParams["server.version"] = f)
                                            }
                                            mg(N("ECATCHER_REPORT_HOST", "") + "/error_204", d)
                                        }
                                        try {
                                            Zj.add(e.message)
                                        } catch (J) {}
    ...
    m.Ia = function(a) {
        ...
        case "apiInfoDelivery":
            if (D(a))
                for (var c in a)
                    a.hasOwnProperty(c) && (this.L[c] = a[c]);
            break;
        case "infoDelivery":
            Ak(this, a);
            break;
        case "initialDelivery":
            D(a) && (window.clearInterval(this.j),
            this.playerInfo = {},
            this.L = {},
            Bk(this, a.apiInterface),
            Ak(this, a));
            break;
        default:
            rk(this, b, a)
    ...
    function Bk(a, b) {
        G(b, function(c) {
            ...
            : xk(c) ? this[c] = function() {
                this.playerInfo = {};
                this.L = {};
                uk(this, c, arguments);
                return this
            }
            : yk(c) ? this[c] = function() {
                var d = 0;
    ...
    m.getVideoEmbedCode = function() {
        var a = Y(this.i, "host") + ("/embed/" + Y(this.i, "videoId"))
          , b = Number(Y(this.i, "width"))
          , c = Number(Y(this.i, "height"));
        if (isNaN(b) || isNaN(c))
    ...
    m.getOptions = function(a) {
        return this.L.namespaces ? a ? this.L[a] ? this.L[a].options || [] : [] : this.L.namespaces || [] : []
    }
    ;
    m.getOption = function(a, b) {
        if (this.L.namespaces && a && b && this.L[a])
            return this.L[a][b]
    }
    ;
    function Ck(a) {
    ...
    E("YT.subscribe", function(a, b, c) {
        ...
        jk[a] = !0;
        for (var d in hk)
            hk.hasOwnProperty(d) && tk(hk[d], a)
    });
    E("YT.unsubscribe", function(a, b, c) {
        Te(a, b, c)
    });
    E("YT.Player", zk);
    qk.prototype.destroy = qk.prototype.destroy;
    qk.prototype.setSize = qk.prototype.setSize;
    qk.prototype.getIframe = qk.prototype.getIframe;
    qk.prototype.addEventListener = qk.prototype.addEventListener;
    zk.prototype.getVideoEmbedCode = zk.prototype.getVideoEmbedCode;
    zk.prototype.getOptions = zk.prototype.getOptions;
    zk.prototype.getOption = zk.prototype.getOption;
    ik.push(function(a) {
        var b = a;
        b || (b = document);
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || kk();
    var Dk = B.onYTReady;
    Dk && Dk();
    var Ek = B.onYouTubeIframeAPIReady;
    Ek && Ek();
    var Fk = B.onYouTubePlayerAPIReady;
    Fk && Fk();
}
).call(this);
